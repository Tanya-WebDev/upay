...
class __TwigTemplate_5f173787a63c555aabff5164b7c7fef6 extends Template
{
    private $source;
    private $macros = [];
...
{%- macro render_table_triggered_handlers(handlers) -%}
    ...
    {%- endfor -%}
{%- endmacro -%}
", "@JMSSerializer/Collector/handlers.html.twig", "/app/vendor/jms/serializer-bundle/Resources/views/Collector/handlers.html.twig");
    }
}
