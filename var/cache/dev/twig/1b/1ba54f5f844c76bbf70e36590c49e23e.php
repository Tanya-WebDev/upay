...
class __TwigTemplate_ad1ed8de335a174d43152daf1ac160ec extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_signIn($context, array $blocks = [])
    {
        $macros = $this->macros;
        $__internal_5a27a8ba21ca79b61932376b2fa922d2 = $this->extensions["Symfony\\Bundle\\WebProfilerBundle\\Twig\\WebProfilerExtension"];
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "block", "signIn"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "block", "signIn"));

        // line 12
        echo "    <button class=\"btn btn-light\" onclick=\"window.location = '";
...
";
    ...
    public function block_sidebar($context, array $blocks = [])
    {
        ...
        // line 16
        echo "    <div class=\"row\">
        <div class=\"col-12 d-flex justify-content-center form-img\">
            <img src=\"";
        // line 18
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("img/payment-1.png"), "html", null, true);
        echo "\" alt=\"payment\" class=\"img\">
        </div>
    </div>
";
    ...
    <div class=\"form\">
        ...
        echo "\" method=\"post\">
            ...
            <div class=\"row\">
                <div class=\"col-12\">
                    ...
                    <input type=\"text\" id=\"username\" class=\"input-field\" name=\"_username\" value=\"";
        // line 38
        ...
        echo "\">
            ...
            <input type=\"password\" id=\"password\" class=\"input-field\" name=\"_password\">
            ...
            <div class=\"row\">
                ...
                <div class=\"col col-xl-9\">
                    <p>If you have no account, you need to <a href=\"";
        // line 53
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_register");
        echo "\">register</a>!</p>
                </div>
...
";
    ...
    {
        return array (  214 => 53,  196 => 38,  188 => 33,  180 => 27,  174 => 25,  171 => 24,  161 => 23,  147 => 18,  143 => 16,  133 => 15,  120 => 12,  110 => 11,  98 => 8,  94 => 7,  91 => 6,  81 => 5,  62 => 3,  39 => 1,);
    }
...
{% block signIn %}
    <button class=\"btn btn-light\" onclick=\"window.location = '{{path('app_register') }}'\">Register</button>
{% endblock %}

{% block sidebar %}
    <div class=\"row\">
        <div class=\"col-12 d-flex justify-content-center form-img\">
            <img src=\"{{ asset('img/payment-1.png') }}\" alt=\"payment\" class=\"img\">
        </div>
    </div>
{% endblock %}
    ...
    <div class=\"form\">
        <form action=\"{{ path('app_login') }}\" method=\"post\">
            ...
            <div class=\"row\">
                <div class=\"col-12\">
                    <label for=\"username\">Email:</label>
                    <input type=\"text\" id=\"username\" class=\"input-field\" name=\"_username\" value=\"{{ last_username }}\">
                </div>
            </div>
            ...
            <div class=\"row\">
                ...
                <div class=\"col col-xl-9\">
                    <p>If you have no account, you need to <a href=\"{{ path('app_register') }}\">register</a>!</p>
                </div>
            </div>
        </form>
    </div>
...
{% endblock %}
", "login/index.html.twig", "/app/templates/login/index.html.twig");
    }
}
